...
O campo `DS_GRAU_ACADEMICO_DISCENTE` pode receber os valores 
`MESTRADO`, 
`DOUTORADO`, 
`MESTRADO PROFISSIONAL` e
`DOUTORADO PROFISSIONAL`. Ajuste os filtros dependendo dos graus que seu programa pode conferir aos alunos.
:::
...
### Distribuição da idade dos discentes de um determinado programa _versus_ todos os discentes
...
### Distribuição da idade dos discentes de uma IES _versus_ todos os discentes
...
### Distribuição da idade dos discentes de uma determinada área de avaliação _versus_ todos os discentes
